...
export { parseOverrides, convertToOverride, determineClasses } from './spreadsheet/overrides-parser.js';
export { SERIES_CONFIGS } from './spreadsheet/series-config.js';
export { STANDINGS_CONFIGS } from './spreadsheet/standings-config.js';
export { getColorMapping, parseName, generateInitials, OVERRIDE_DEFAULTS, CLASS_COLOR_MAPPINGS } from './spreadsheet/overrides-config.js';
export type { DriverEntry, RaceResult, StandingsEntry, DriverOverride } from './spreadsheet/types.js';
...
export type { ColorMapping } from './spreadsheet/overrides-config.js';
